genfuzzfuncs is an early stage prototype for automatically generating fuzz functions, similar in spirit to [cweill/gotests](https://github.com/cweill/gotests). 
